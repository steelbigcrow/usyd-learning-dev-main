...
class NNModel_SimpleLoRAMLP(NNModel):
    ...
    def create_model(self, args: NNModelArgs) -> AbstractNNModel:
        ...
        self._fc1 = MSLoRALinear(784, 200, r=16, lora_alpha=int(rank * scaling),
                                 lora_dropout=0.0, fan_in_fan_out=False,
                                 merge_weights=False, bias=use_bias)
        self._relu1 = nn.ReLU()
        self._fc2 = MSLoRALinear(200, 200, r=10, lora_alpha=int(rank * scaling),
                                 lora_dropout=0.0, fan_in_fan_out=False,
                                 merge_weights=False, bias=use_bias)
        self._relu2 = nn.ReLU()
        self._fc3 = MSLoRALinear(200, 10, r=10, lora_alpha=int(rank * scaling),
                                 lora_dropout=0.0, fan_in_fan_out=False,
                                 merge_weights=False, bias=use_bias)
