...
class SvdAbClientTrainingStrategy(ClientStrategy):
    '''
    Light weight observation method for SVD(AB)

    Forward propagation is LoRA only.
    ...
    def observation(self):
        ...
        # set lora mode to lora only
        LoRAUtils.set_lora_mode_for_model(observation_model, 'lora_only')
