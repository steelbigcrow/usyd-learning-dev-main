...
class TestAdaLoRASVDIntegration(unittest.TestCase):
    def test_adalora_svd_end_to_end(self):
        # Bootstrap imports and cwd
        ensure_startup(__file__)

        cfg = os.path.abspath(os.path.join(os.path.dirname(__file__), "adalora_svd.yaml"))
