...
def main():
    ...
    # LoRA + KMNIST(long-tail) + SVD aggregation (60 rounds)
    g_app.load_app_config("./fl_lora_sample/convergence_experiment/additional_kmnist/lora_long_tail_svd_round60_epoch1.yaml")
