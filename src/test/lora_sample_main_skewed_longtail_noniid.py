...
def main():
    ...
    # Use MNIST ZP skewed long-tail non-IID with homogeneous rank
    g_app.load_app_config(
        "./fl_lora_sample/convergence_experiment/lora_fmnist/RBLA/Heterogeneous Rank/rbla_fmnist_long_tail_heterogeneous_round60_epoch1.yaml"
    )
